...
export class ViewerComponent implements OnInit {
    ...
    public resetAllTools() {
        if (this.imageCount > 0) {            
            cornerstoneTools.setToolPassiveForElement(this.element, 'Wwwc')
            cornerstoneTools.setToolPassiveForElement(this.element, 'Zoom')
            cornerstoneTools.setToolPassiveForElement(this.element, 'Pan')
            cornerstoneTools.setToolPassiveForElement(this.element, 'StackScroll')
            cornerstoneTools.setToolPassiveForElement(this.element, 'Length')
            cornerstoneTools.setToolPassiveForElement(this.element, 'Angle')
            cornerstoneTools.setToolPassiveForElement(this.element, 'Probe')
            cornerstoneTools.setToolPassiveForElement(this.element, 'EllipticalRoi')
            cornerstoneTools.setToolPassiveForElement(this.element, 'RectangleRoi')            
            this.stopClip()
        }
    }
